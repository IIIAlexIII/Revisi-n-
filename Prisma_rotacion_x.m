...
angle_rad = gradoaradianes(45); %La variable "angle_rad" realiza la operacion con la funcion creada llamada "gradoaradianes"
...
P0r = Rx*P0'; %Operación para realizar la rotacion
P1r = Rx*P1'; %Operación para realizar la rotacion
P2r = Rx*P2'; %Operación para realizar la rotacion
P3r = Rx*P3'; %Operación para realizar la rotacion
P4r = Rx*P4'; %Operación para realizar la rotacion
P5r = Rx*P5'; %Operación para realizar la rotacion
P6r = Rx*P6'; %Operación para realizar la rotacion
P7r = Rx*P7'; %Operación para realizar la rotacion
...
line ([P4r(1) P4r(1)],[P4r(2) P5r(2)],[P4r(3) P5r(3)], 'color', [1 0 1], 'linewidth',3); %Establece el eje Rosa
line ([P5r(1) P5r(1)],[P5r(2) P6r(2)],[P5r(3) P6r(3)], 'color', [1 0 1], 'linewidth',3); %Establece el eje Rosa
line ([P6r(1) P6r(1)],[P6r(2) P7r(2)],[P6r(3) P7r(3)], 'color', [1 0 1], 'linewidth',3); %Establece el eje Rosa
line ([P7r(1) P7r(1)],[P7r(2) P4r(2)],[P7r(3) P4r(3)], 'color', [1 0 1], 'linewidth',3); %Establece el eje Rosa
