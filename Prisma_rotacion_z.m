...
P4r = Rz*P4'; %Operación para realizar la rotacion
P5r = Rz*P5'; %Operación para realizar la rotacion
P6r = Rz*P6'; %Operación para realizar la rotacion
P7r = Rz*P7'; %Operación para realizar la rotacion
...
line ([P4r(1) P5r(1)],[P4r(2) P5r(2)],[P4r(3) P4r(3)], 'color', [1 0 1], 'linewidth',3); %Establece el eje Rosa
line ([P5r(1) P6r(1)],[P5r(2) P6r(2)],[P5r(3) P5r(3)], 'color', [1 0 1], 'linewidth',3); %Establece el eje Rosa
line ([P6r(1) P7r(1)],[P6r(2) P7r(2)],[P6r(3) P6r(3)], 'color', [1 0 1], 'linewidth',3); %Establece el eje Rosa
line ([P7r(1) P4r(1)],[P7r(2) P4r(2)],[P7r(3) P7r(3)], 'color', [1 0 1], 'linewidth',3); %Establece el eje Rosa
